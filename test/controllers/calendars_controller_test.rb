...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { end_time: @calendar.end_time, start_time: @calendar.start_time, subject: @calendar.subject, user_id: @calendar.user_id } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { end_time: @calendar.end_time, start_time: @calendar.start_time, subject: @calendar.subject, user_id: @calendar.user_id } }
